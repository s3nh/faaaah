...
historical_pairs = [
    {"complaint": "My order never arrived and I was charged.", "answer": "We apologize for the delay. We have initiated a full refund within 5-7 business days. [REF-2024-001]"},
    {"complaint": "I want compensation for damages caused by a faulty product.", "answer": "Compensation claims for consequential damages require escalation to our resolution team. We cannot confirm amounts at this stage."},
    {"complaint": "Your support team is unresponsive.", "answer": "We sincerely apologize. A senior representative will contact you within 24 hours."},
]
...
recommendation = AnalyticRecommendation(
    recommended_actions=[
        ...
        ResolutionAction(action_type="goodwill_voucher", value="20 EUR", condition="VIP customer or first-time complaint"),
    ...
    policy_references=["POL-DELIVERY-003", "POL-REFUND-001", "POL-LEGAL-ESCALATION-007"],
    analyst_notes="Customer waiting 3 weeks. High churn risk. Expedite.",
...
print(f"Rejected actions:     {result['rejected_actions']}")
